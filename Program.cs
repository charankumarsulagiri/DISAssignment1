    ...
    class Program
    {
       ...
       */
        ...
        private static bool ArrayStringsAreEqual(string[] bulls_string1, string[] bulls_string2)
        {
            try
            {
                string[] input1 = bulls_string1;
                string[] input2 = bulls_string2;
                string temp1 = "";
                string temp2 = "";
                for (int i = 0; i < input1.Length; i++)
                {
                    temp1 = temp1 + input1[i];
                }

                for (int i = 0; i < input2.Length; i++)
                {
                    temp2 = temp2 + input2[i];
                }
                if (temp1 == temp2)
                    return true;
                else
        ...
        */
        ...
        private static int DiagonalSum(int[,] bulls_grid)
        {
            try
            {
                ...
                int a = Convert.ToInt32(Math.Sqrt(len));
                int sum = 0;
                for (int j = 0; j < a; j++)
                {
                    sum = sum + bulls_grid[j, j] + bulls_grid[j, a - j - 1];
                }
                if (a % 2 != 0)
                {
        ...
        */
        ...
        private static string ReversePrefix(string bulls_string6, char ch)
        {
            try
            {
                string[] a = new string[bulls_string6.Length];
                for (int i = 0; i < bulls_string6.Length; i++)
                {
                    if (bulls_string6[i] == ch)
                    {
                        a = bulls_string6.Split(ch);
                    }
                }
                string c = "";
